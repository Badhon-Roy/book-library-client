...
const BookDetails = () => {
    ...
    useEffect(() => {
        fetch(`https://book-library-production.up.railway.app/allBooks/${id}`)
            .then(res => res.json())
            .then(data => {
                setBook(data)
    ...
    useEffect(() => {
        fetch('https://book-library-production.up.railway.app/borrowBooks')
            .then(res => res.json())
    ...
    const handleReturnDate = e => {
        ...
        // quantity - 1
        fetch(`https://book-library-production.up.railway.app/allBooks/${id}/decrement`, {
            method: 'PUT',
            headers: {
